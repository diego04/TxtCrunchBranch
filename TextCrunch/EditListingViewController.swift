...
class EditListingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let urlandisbn = url+bookISBN
            
        json = JSON(url:urlandisbn)
        numberofbooks = toString(json["totalItems"]).toInt()!*/
        }
        ...
        // this is just a huge json object of array and dictionary
        // ill just leave these as is
        //
        var bookdictiona = json["items"]
        var bookdictionar = bookdictiona[0]
        var bookdictionary = bookdictionar["volumeInfo"]
        //
        ...
        /*if(numberofbooks <1 && listing == nil){
            //found a bug
    ...
    @IBAction func updateListing(sender: AnyObject) {
        ...
        //when Google Books doesnt have the books
        //the user has to manually input the book information
        //and the app needs to save the book that the user entered
        //manually
        /*
        if(numberofbooks < 1 && listing == nil){
            var book = Book()
